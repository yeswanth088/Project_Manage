...
We implemented service layer architecture, foreign key relationships, enum-based status tracking, and unit testing to ensure reliability and maintainability.

Technologies Used:
ASP.NET Core MVC → Frontend + Controllers
Entity Framework Core → Database interaction
SQL Server → Data storage
Razor Views → UI pages
